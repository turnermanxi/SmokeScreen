...
const ContentBelowShelf = ({ products }) => {
  ...
  return (
    <section>
      <div className="arrow" onClick={handleArrowClick}><img id='downarrow' src="neonarrow.png" alt="Down Arrow" /></div>
      <section
                className={`content-below-shelf py-5 ${isVisible ? "visible" : "hidden"}`}
                style={{
                    transition: "max-height 0.5s ease-in-out, opacity 0.5s ease-in-out",
                    maxHeight: isVisible ? "250rem" : "0",
                    overflow: "hidden",
